...
batch_size = 32
num_workers = 4
lr = 2.6e-3 # Khoi tao learning rate
momentum = 0.9
weight_decay = 0.0005  #momentum argument for SGD optimizer
nms_threshold = 0.5
epochs = 100
multistep = [43,54] #Tai epoch do ty le hoc se giam dan
root_path = "coco"      #Thu muc chua dataset
save_folder = 'trained_models'    #Thu muc chua pre-train
log_path = "tensorboard/SSD"  #Luu cac gia tri loss,acc